...
public class StringUtils
{
	...
	/**
	 * Método encargado de generar el titulo del query.
	 *
	 * @param as_dato the as dato
	 * @return the titulo query
	 */
	public static String getTituloQuery(String as_dato)
	{
		return as_dato.replaceAll(IdentificadoresCommon.SIMBOLO_GUION_BAJO, IdentificadoresCommon.ESPACIO_VACIO);
	}
	...
	/**
	 * Cambiar a mayúscula el primer elemento de una cadena.
	 *
	 * @author cvargas
	 * @param as_val <code>java.lang.String</code> argumento a modificar el primer elemento.
	 * @return <code>java.lang.String</code> con el primer elemento de la cadena en mayúscula,
	 * de lo contrario retorna <code>null</code> si <i>as_val </i> es
	 *         <code>null</code>.
	 */
	public static String upperCaseFirst(String as_val)
	{
		String ls_return;

		ls_return = null;

		if(isValidString(as_val))
		{
			char[] lca_arr;

			lca_arr        = as_val.toCharArray();
			lca_arr[0]     = Character.toUpperCase(lca_arr[0]);

			ls_return = new String(lca_arr);
		}

package com.bachue.snr.prosnr06.web.Scheduler;
...
/**
 * Agendador de tareas automáticas QUARTZ para componente Envio Documento
 *
 * @author Edgar Prieto
 *
 */
public class EnvioDocumentoScheduler extends com.bachue.snr.common.scheduler.SNRClusterScheduler
{
	/** Constante clh_LOGGER. */
	private static final LoggerHandler clh_LOGGER = (LoggerHandler)com.bachue.snr.prosnr01.common.utils.LoggingHelper
			.getLogger(EnvioDocumentoScheduler.class);
		...
		)
		{
			for(String ls_nombreJob : acs_nombresJob)
			{
				if(StringUtils.isValidString(ls_nombreJob))
				{
					...
					if(ls_nombreJob.equals(EnvioGestorDocumentalJob.getId()))
						iniciarJob(

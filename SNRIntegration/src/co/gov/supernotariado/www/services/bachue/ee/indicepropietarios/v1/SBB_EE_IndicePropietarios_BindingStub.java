/**
 * SBB_EE_IndicePropietarios_BindingStub.java
 *
...
/**
 * Clase que contiene todos las propiedades SBB_EE_IndicePropietarios_BindingStub.
 *
 * @author  Julián David Vaca Rodriguez
 * Fecha de Creacion: 30/07/2020
 */
public class SBB_EE_IndicePropietarios_BindingStub extends org.apache.axis.client.Stub implements co.gov.supernotariado.www.services.bachue.ee.indicepropietarios.v1.SBB_EE_IndicePropietarios_PortType
{
	...
	/**
	 * Instancia un nuevo objeto SB B E E indice propietarios binding stub.
	 *
	 * @throws AxisFault cuando se produce algun error en el proceso
	 */
	public SBB_EE_IndicePropietarios_BindingStub()
	 ...
	 * @throws AxisFault cuando se produce algun error en el proceso
	 */
	public SBB_EE_IndicePropietarios_BindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service)
	    throws org.apache.axis.AxisFault
	{
		this(service);
	 ...
	 * @throws AxisFault cuando se produce algun error en el proceso
	 */
	public SBB_EE_IndicePropietarios_BindingStub(javax.xml.rpc.Service service)
	    throws org.apache.axis.AxisFault
	{
		if(service == null)
		...
		qName = new javax.xml.namespace.QName(
			    "https://www.supernotariado.gov.co/services/bachue/ee/indicepropietarios/consultar/v1",
			    ">tipoEntradaIndicePropietarios>auditoriaEntidad"
			);
		cachedSerQNames.add(qName);
		cls = java.lang.String.class;
		cachedSerClasses.add(cls);
		...
		qName = new javax.xml.namespace.QName(
			    "https://www.supernotariado.gov.co/services/bachue/ee/indicepropietarios/consultar/v1",
			    ">tipoEntradaIndicePropietarios>auditoriaUsuario"
			);
		cachedSerQNames.add(qName);
		cls = java.lang.String.class;
		cachedSerClasses.add(cls);
		...
		qName = new javax.xml.namespace.QName(
			    "https://www.supernotariado.gov.co/services/bachue/ee/indicepropietarios/consultar/v1",
			    ">tipoEntradaIndicePropietarios>codCirculoRegistral"
			);
		cachedSerQNames.add(qName);
		cls = java.lang.String.class;
		cachedSerClasses.add(cls);
		...
		qName = new javax.xml.namespace.QName(
			    "https://www.supernotariado.gov.co/services/bachue/ee/indicepropietarios/consultar/v1",
			    ">tipoEntradaIndicePropietarios>entidad"
			);
		cachedSerQNames.add(qName);
		cls = java.lang.String.class;
		cachedSerClasses.add(cls);
		...
		cachedSerQNames.add(qName);
		cls = co.gov.supernotariado.www.services.bachue.ee.indicepropietarios.consultar.v1.TipoEntradaIndicePropietariosTipoDocumentoPersona.class;
		cachedSerClasses.add(cls);
		...
		cachedSerQNames.add(qName);
		cls = co.gov.supernotariado.www.services.bachue.ee.indicepropietarios.consultar.v1.TipoEntradaIndicePropietariosTipoIdentificacionPredio.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(enumsf);
		cachedDeserFactories.add(enumdf);
		...
		qName = new javax.xml.namespace.QName(
			    "https://www.supernotariado.gov.co/services/bachue/ee/indicepropietarios/consultar/v1",
			    ">tipoSalidaIndicePropietarios>fechaHoraConsulta"
			);
		cachedSerQNames.add(qName);
		...
		qName = new javax.xml.namespace.QName(
			    "https://www.supernotariado.gov.co/services/bachue/ee/indicepropietarios/consultar/v1",
			    ">tipoSalidaIndicePropietarios>numeroConsulta"
			);
		cachedSerQNames.add(qName);
		cls = long.class;
		cachedSerClasses.add(cls);
		...
		cachedSerQNames.add(qName);
		cls = co.gov.supernotariado.www.services.bachue.ee.indicepropietarios.consultar.v1.InmuebleDTO.class;
		cachedSerClasses.add(cls);
		...
		cachedSerQNames.add(qName);
		cls = co.gov.supernotariado.www.services.bachue.ee.indicepropietarios.consultar.v1.PropietarioDTO.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		cachedDeserFactories.add(beandf);
		...
		cachedSerQNames.add(qName);
		cls = co.gov.supernotariado.www.services.bachue.ee.indicepropietarios.consultar.v1.TipoEntradaIndicePropietarios.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		cachedDeserFactories.add(beandf);
		...
		cachedSerQNames.add(qName);
		cls = co.gov.supernotariado.www.services.bachue.ee.indicepropietarios.consultar.v1.TipoSalidaIndicePropietarios.class;
		cachedSerClasses.add(cls);
		cachedSerFactories.add(beansf);
		cachedDeserFactories.add(beandf);
	}
	    ...
	    throws java.rmi.RemoteException
	{
		...
		_call.setSOAPActionURI("https://www.supernotariado.gov.co/services/bachue/cb/indicepropietarios/consultar/v1");
		...
		try
		{
			...
			else
			{
				...
				try
				{
					return (co.gov.supernotariado.www.services.bachue.ee.indicepropietarios.consultar.v1.TipoSalidaIndicePropietarios)_resp;
				}
				catch(java.lang.Exception _exception)
				{
					return (co.gov.supernotariado.www.services.bachue.ee.indicepropietarios.consultar.v1.TipoSalidaIndicePropietarios)org.apache.axis.utils.JavaUtils
						.convert(
						    _resp,
						    co.gov.supernotariado.www.services.bachue.ee.indicepropietarios.consultar.v1.TipoSalidaIndicePropietarios.class
						);
				}
			}
		}
	...
	private static void _initOperationDesc1()
	{
		...
		param = new org.apache.axis.description.ParameterDesc(
			    ...
			    co.gov.supernotariado.www.services.bachue.ee.indicepropietarios.consultar.v1.TipoEntradaIndicePropietarios.class,
			    false, false
			);

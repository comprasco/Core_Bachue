/**
 * TipoEntradaConsultaActosTurno.java
 *
...
/**
 * Clase que contiene todos las propiedades TipoEntradaConsultaActosTurno.
 *
 * @author  Julián David Vaca Rodriguez
 * Fecha de Creacion: 3/09/2020
 */
public class TipoEntradaConsultaActosTurno implements java.io.Serializable
{
	/** Constante serialVersionUID. */
	private static final long serialVersionUID = -4097509220484887816L;

	/** Propiedad type desc. */
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
		    TipoEntradaConsultaActosTurno.class, true
		);
	...
	/**
	 * Instancia un nuevo objeto tipo entrada consulta actos turno.
	 */
	public TipoEntradaConsultaActosTurno()
	{
	}
	...
	/**
	 * Sets the criterioBusqueda value for this TipoEntradaConsultaActosTurno.
	 *
	 * @param criterioBusqueda correspondiente al valor de criterio busqueda
	 */
	...
	/**
	 * Gets the criterioBusqueda value for this TipoEntradaConsultaActosTurno.
	 *
	...
	/**
	 * Sets the modulo value for this TipoEntradaConsultaActosTurno.
	 *
	 * @param modulo correspondiente al valor de modulo
	 */
	...
	/**
	 * Gets the modulo value for this TipoEntradaConsultaActosTurno.
	 *
	 * @return modulo
	 */
	...
	/**
	 * Sets the valorCriterioBusqueda value for this TipoEntradaConsultaActosTurno.
	 *
	 * @param valorCriterioBusqueda correspondiente al valor de valor criterio busqueda
	 */
	...
	/**
	 * Gets the valorCriterioBusqueda value for this TipoEntradaConsultaActosTurno.
	 *
	...
	{
		if(!(obj instanceof TipoEntradaConsultaActosTurno))
			return false;

		TipoEntradaConsultaActosTurno other = (TipoEntradaConsultaActosTurno)obj;

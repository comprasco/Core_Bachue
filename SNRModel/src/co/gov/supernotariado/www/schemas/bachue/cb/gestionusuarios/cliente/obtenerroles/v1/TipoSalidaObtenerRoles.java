...
public class TipoSalidaObtenerRoles implements java.io.Serializable
{
	...
	public TipoSalidaObtenerRoles(
	    RolTypeOR[] roles, java.math.BigInteger codigoMensaje, java.lang.String descripcionMensaje
	)
	{
		this.roles                  = roles;
	 ...
	 * @param roles
	 */
	public void setRoles(RolTypeOR[] roles)
	{
		this.roles = roles;
	}

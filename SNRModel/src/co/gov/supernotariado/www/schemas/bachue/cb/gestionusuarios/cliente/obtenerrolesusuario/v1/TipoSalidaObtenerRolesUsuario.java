...
public class TipoSalidaObtenerRolesUsuario implements java.io.Serializable
{
	...
	public TipoSalidaObtenerRolesUsuario(
	    RolTypeORU[] roles, java.math.BigInteger codigoMensaje, java.lang.String descripcionMensaje
	)
	{
		this.roles                  = roles;
	 ...
	 * @param roles
	 */
	public void setRoles(RolTypeORU[] roles)
	{
		this.roles = roles;
	}

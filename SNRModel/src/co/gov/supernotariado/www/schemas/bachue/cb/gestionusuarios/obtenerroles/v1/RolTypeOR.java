...
/**
 * Clase que contiene todos las propiedades RolTypeOR.
 *
 * @author  Jorge Esteban Patiño Fonseca
 * Fecha de Creacion: 11/06/2020
 */
public class RolTypeOR implements java.io.Serializable
{
	
	/** Constante serialVersionUID. */
	private static final long serialVersionUID = -6565628963413601574L;

	/** Propiedad type desc. */
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
		    RolTypeOR.class, true
		);
	...
	static
	{
		...
		elemField.setXmlName(
		    new javax.xml.namespace.QName(
		        "https://www.supernotariado.gov.co/schemas/bachue/cb/gestionusuarios/obtenerroles/v1", "codigoRol"
		    )
		);
		...
		elemField.setXmlName(
		    new javax.xml.namespace.QName(
		        "https://www.supernotariado.gov.co/schemas/bachue/cb/gestionusuarios/obtenerroles/v1", "nombreRol"
		    )
		);
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setNillable(false);
		...
		elemField.setXmlName(
		    new javax.xml.namespace.QName(
		        "https://www.supernotariado.gov.co/schemas/bachue/cb/gestionusuarios/obtenerroles/v1", "componente"
		    )
		);
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setNillable(false);
	...
	/**
	 * Instancia un nuevo objeto rol type OR.
	 */
	public RolTypeOR()
	{
	}
	 ...
	 */
	public RolTypeOR(java.lang.String codigoRol, java.lang.String nombreRol, java.lang.String componente)
	{
	...
	/**
	 * Sets the codigoRol value for this RolTypeOR.
	 *
	 * @param codigoRol de codigo rol
	 */
	...
	/**
	 * Gets the codigoRol value for this RolTypeOR.
	 *
	 * @return codigoRol
	 */
	...
	/**
	 * Sets the componente value for this RolTypeOR.
	 *
	 * @param componente de componente
	 */
	...
	/**
	 * Gets the componente value for this RolTypeOR.
	 *
	 * @return componente
	 */
	...
	/**
	 * Sets the nombreRol value for this RolTypeOR.
	 *
	 * @param nombreRol de nombre rol
	 */
	...
	/**
	 * Gets the nombreRol value for this RolTypeOR.
	 *
	 * @return nombreRol
	 */
	...
	{
		if(!(obj instanceof RolTypeOR))
			return false;

		RolTypeOR other = (RolTypeOR)obj;

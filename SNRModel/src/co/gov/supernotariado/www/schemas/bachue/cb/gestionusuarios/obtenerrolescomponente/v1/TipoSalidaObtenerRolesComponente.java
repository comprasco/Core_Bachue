...
/**
 * Clase que contiene todos las propiedades TipoSalidaObtenerRolesComponente.
 *
...
public class TipoSalidaObtenerRolesComponente implements java.io.Serializable
{
	...
	private static final long serialVersionUID = 7442897448286292886L;
	...
	/** Propiedad roles. */
	private co.gov.supernotariado.www.schemas.bachue.cb.gestionusuarios.obtenerrolescomponente.v1.RolTypeORC[] roles;
	...
	/**
	 * Instancia un nuevo objeto tipo salida obtener roles componente.
	 */
	 ...
	 */
	public TipoSalidaObtenerRolesComponente(
	    co.gov.supernotariado.www.schemas.bachue.cb.gestionusuarios.obtenerrolescomponente.v1.RolTypeORC[] roles,
	 ...
	 * @return roles
	 */
	public co.gov.supernotariado.www.schemas.bachue.cb.gestionusuarios.obtenerrolescomponente.v1.RolTypeORC[] getRoles()
	{
		return roles;
	}

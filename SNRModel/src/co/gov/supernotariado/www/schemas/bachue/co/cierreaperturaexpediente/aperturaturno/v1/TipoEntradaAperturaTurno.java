...
/**
 * Clase que contiene todos las propiedades TipoEntradaAperturaTurno.
 *
 * @author  Jorge Esteban Patiño Fonseca
 * Fecha de Creacion: 4/05/2020
 */
public class TipoEntradaAperturaTurno implements java.io.Serializable
{
	/** Propiedad type desc. */
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
		    TipoEntradaAperturaTurno.class, true
		);
	...
	private co.gov.supernotariado.www.schemas.bachue.co.cierreaperturaexpediente.aperturaturno.v1.Parametro[] parametros;

	/** Propiedad hash code calc. */
	private boolean __hashCodeCalc = false;

	/**
	 * Instancia un nuevo objeto tipo entrada apertura turno.
	 */
	public TipoEntradaAperturaTurno()
	{
	}
	...
	public TipoEntradaAperturaTurno(
	    ...
	    co.gov.supernotariado.www.schemas.bachue.co.cierreaperturaexpediente.aperturaturno.v1.Parametro[] parametros
	)
	{
	...
	/**
	 * Sets the parametros value for this TipoEntradaAperturaTurno.
	 *
	 * @param parametros de parametros
	 */
	...
	/**
	 * Gets the parametros value for this TipoEntradaAperturaTurno.
	 *
	 * @return parametros
	 */
	public co.gov.supernotariado.www.schemas.bachue.co.cierreaperturaexpediente.aperturaturno.v1.Parametro[] getParametros()
	{
		return parametros;
	}
	...
	/**
	 * Sets the sistemaOrigen value for this TipoEntradaAperturaTurno.
	 *
	 * @param sistemaOrigen de sistema origen
	 */
	...
	/**
	 * Gets the sistemaOrigen value for this TipoEntradaAperturaTurno.
	 *
	...
	{
		if(!(obj instanceof TipoEntradaAperturaTurno))
			return false;

		TipoEntradaAperturaTurno other = (TipoEntradaAperturaTurno)obj;

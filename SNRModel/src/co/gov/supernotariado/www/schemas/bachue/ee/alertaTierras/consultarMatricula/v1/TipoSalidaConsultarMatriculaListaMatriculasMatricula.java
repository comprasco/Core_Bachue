/**
 * TipoSalidaConsultarMatriculaListaMatriculasMatricula.java
 *
...
/**
 * Clase que contiene todos las propiedades TipoSalidaConsultarMatriculaListaMatriculasMatricula.
 *
 * @author  Carlos Calderón
 * Fecha de Creacion: 1/04/2020
 */
public class TipoSalidaConsultarMatriculaListaMatriculasMatricula implements java.io.Serializable
{
	/** Constante serialVersionUID. */
	private static final long serialVersionUID = 3164545620957938125L;

	/** Propiedad type desc. */
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
		    TipoSalidaConsultarMatriculaListaMatriculasMatricula.class, true
		);
	...
	static
	{
		typeDesc.setXmlType(
		    new javax.xml.namespace.QName(
		        "https://www.supernotariado.gov.co/schemas/bachue/ee/alertaTierras/consultarMatricula/v1",
		        ">>tipoSalidaConsultarMatricula>listaMatriculas>matricula"
		    )
		);
		...
		elemField.setXmlName(
		    new javax.xml.namespace.QName(
		        "https://www.supernotariado.gov.co/schemas/bachue/ee/alertaTierras/consultarMatricula/v1", "esDerivada"
		    )
		);
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setNillable(false);
		...
		elemField.setXmlName(
		    new javax.xml.namespace.QName(
		        "https://www.supernotariado.gov.co/schemas/bachue/ee/alertaTierras/consultarMatricula/v1", "numPredial"
		    )
		);
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setNillable(false);
	...
	/**
	 * Instancia un nuevo objeto tipo salida consultar matricula lista matriculas matricula.
	 */
	public TipoSalidaConsultarMatriculaListaMatriculasMatricula()
	{
	}
	...
	/**
	 * Gets the codCirculoRegistral value for this TipoSalidaConsultarMatriculaListaMatriculasMatricula.
	 *
	...
	/**
	 * Sets the codCirculoRegistral value for this TipoSalidaConsultarMatriculaListaMatriculasMatricula.
	 *
	 * @param codCirculoRegistral de cod circulo registral
	 */
	...
	/**
	 * Gets the numMatriculaInmobiliaria value for this TipoSalidaConsultarMatriculaListaMatriculasMatricula.
	 *
	...
	/**
	 * Sets the numMatriculaInmobiliaria value for this TipoSalidaConsultarMatriculaListaMatriculasMatricula.
	 *
	 * @param numMatriculaInmobiliaria de num matricula inmobiliaria
	 */
	...
	/**
	 * Gets the esDerivada value for this TipoSalidaConsultarMatriculaListaMatriculasMatricula.
	 *
	 * @return esDerivada
	 */
	...
	/**
	 * Sets the esDerivada value for this TipoSalidaConsultarMatriculaListaMatriculasMatricula.
	 *
	 * @param esDerivada de es derivada
	 */
	...
	/**
	 * Gets the numPredial value for this TipoSalidaConsultarMatriculaListaMatriculasMatricula.
	 *
	 * @return numPredial
	 */
	...
	/**
	 * Sets the numPredial value for this TipoSalidaConsultarMatriculaListaMatriculasMatricula.
	 *
	 * @param numPredial de num predial
	 */
	...
	{
		if(!(obj instanceof TipoSalidaConsultarMatriculaListaMatriculasMatricula))
			return false;

		TipoSalidaConsultarMatriculaListaMatriculasMatricula other = (TipoSalidaConsultarMatriculaListaMatriculasMatricula)obj;

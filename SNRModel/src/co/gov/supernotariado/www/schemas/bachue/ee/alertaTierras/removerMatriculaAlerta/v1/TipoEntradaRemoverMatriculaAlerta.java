/**
 * TipoEntradaRemoverMatriculaAlerta.java
 *
...
/**
 * Clase que contiene todos las propiedades TipoEntradaRemoverMatriculaAlerta.
 *
 * @author  Carlos Calderón
 * Fecha de Creacion: 3/04/2020
 */
public class TipoEntradaRemoverMatriculaAlerta implements java.io.Serializable
{
	/** Constante serialVersionUID. */
	private static final long serialVersionUID = -1132237873857241569L;

	/** Propiedad type desc. */
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
		    TipoEntradaRemoverMatriculaAlerta.class, true
		);
	...
	static
	{
		typeDesc.setXmlType(
		    new javax.xml.namespace.QName(
		        ...
		        "tipoEntradaRemoverMatriculaAlerta"
		    )
		);
	...
	/**
	 * Instancia un nuevo objeto tipo entrada remover matricula alerta.
	 */
	public TipoEntradaRemoverMatriculaAlerta()
	{
	}
	...
	/**
	 * Gets the idAlerta value for this TipoEntradaRemoverMatriculaAlerta.
	 *
	 * @return idAlerta
	 */
	...
	/**
	 * Sets the idAlerta value for this TipoEntradaRemoverMatriculaAlerta.
	 *
	 * @param idAlerta de id alerta
	 */
	...
	/**
	 * Gets the codCirculoRegistral value for this TipoEntradaRemoverMatriculaAlerta.
	 *
	...
	/**
	 * Sets the codCirculoRegistral value for this TipoEntradaRemoverMatriculaAlerta.
	 *
	 * @param codCirculoRegistral de cod circulo registral
	 */
	...
	/**
	 * Gets the numMatriculaInmobiliaria value for this TipoEntradaRemoverMatriculaAlerta.
	 *
	...
	/**
	 * Sets the numMatriculaInmobiliaria value for this TipoEntradaRemoverMatriculaAlerta.
	 *
	 * @param numMatriculaInmobiliaria de num matricula inmobiliaria
	 */
	...
	{
		if(!(obj instanceof TipoEntradaRemoverMatriculaAlerta))
			return false;

		TipoEntradaRemoverMatriculaAlerta other = (TipoEntradaRemoverMatriculaAlerta)obj;

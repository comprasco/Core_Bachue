/**
 * TipoSalidaConsultarHistoricoPropiedades.java
 *
 ...
 */
public class TipoSalidaConsultarHistoricoPropiedades implements java.io.Serializable
{
	/** Constante serialVersionUID. */
	private static final long serialVersionUID = -2335714708093243513L;

	/** Propiedad type desc. */
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
		    TipoSalidaConsultarHistoricoPropiedades.class, true
		);
	 ...
	 *                                 ingresada */
	private co.gov.supernotariado.www.services.bachue.cb.SBB_CB_HistoricoPropietarios.consultarHistoricoPropiedades.v1.PropietarioDTO[] propietarios;

	/** Propiedad hash code calc. */
	private boolean __hashCodeCalc = false;

	/**
	 * Instancia un nuevo objeto tipo salida consultar historico propiedades.
	 */
	public TipoSalidaConsultarHistoricoPropiedades()
	{
	}
	 ...
	 */
	public TipoSalidaConsultarHistoricoPropiedades(
	    co.gov.supernotariado.www.services.bachue.cb.SBB_CB_HistoricoPropietarios.consultarHistoricoPropiedades.v1.PropietarioDTO[] propietarios,
	...
	/**
	 * Gets the propietarios value for this TipoSalidaConsultarHistoricoPropiedades.
	 *
	 * @return propietarios   * lista de propietarios de la matricula
	     *                                 ingresada
	 */
	public co.gov.supernotariado.www.services.bachue.cb.SBB_CB_HistoricoPropietarios.consultarHistoricoPropiedades.v1.PropietarioDTO[] getPropietarios()
	{
		return propietarios;
	}

	/**
	 * Sets the propietarios value for this TipoSalidaConsultarHistoricoPropiedades.
	 *
	...
	public void setPropietarios(
	    int i,
	    co.gov.supernotariado.www.services.bachue.cb.SBB_CB_HistoricoPropietarios.consultarHistoricoPropiedades.v1.PropietarioDTO _value
	)
	{
	...
	/**
	 * Gets the codMensaje value for this TipoSalidaConsultarHistoricoPropiedades.
	 *
	...
	/**
	 * Sets the codMensaje value for this TipoSalidaConsultarHistoricoPropiedades.
	 *
	...
	/**
	 * Gets the descripcionMensaje value for this TipoSalidaConsultarHistoricoPropiedades.
	 *
	...
	/**
	 * Sets the descripcionMensaje value for this TipoSalidaConsultarHistoricoPropiedades.
	 *
	...
	{
		if(!(obj instanceof TipoSalidaConsultarHistoricoPropiedades))
			return false;

		TipoSalidaConsultarHistoricoPropiedades other = (TipoSalidaConsultarHistoricoPropiedades)obj;

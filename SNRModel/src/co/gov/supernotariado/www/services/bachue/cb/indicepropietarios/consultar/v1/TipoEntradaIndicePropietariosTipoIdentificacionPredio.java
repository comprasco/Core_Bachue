...
public class TipoEntradaIndicePropietariosTipoIdentificacionPredio implements java.io.Serializable {
    ...
    /** Constante matricula. */
    public static final TipoEntradaIndicePropietariosTipoIdentificacionPredio matricula = new TipoEntradaIndicePropietariosTipoIdentificacionPredio(_matricula);
    
    /** Constante numeroPredial. */
    public static final TipoEntradaIndicePropietariosTipoIdentificacionPredio numeroPredial = new TipoEntradaIndicePropietariosTipoIdentificacionPredio(_numeroPredial);
    
    /** Constante numeroPredialAnterior. */
    public static final TipoEntradaIndicePropietariosTipoIdentificacionPredio numeroPredialAnterior = new TipoEntradaIndicePropietariosTipoIdentificacionPredio(_numeroPredialAnterior);
    
    /** Constante NUPRE. */
    public static final TipoEntradaIndicePropietariosTipoIdentificacionPredio NUPRE = new TipoEntradaIndicePropietariosTipoIdentificacionPredio(_NUPRE);
    ...
    public static TipoEntradaIndicePropietariosTipoIdentificacionPredio fromValue(java.lang.String value)
        ...
        TipoEntradaIndicePropietariosTipoIdentificacionPredio enumeration = (TipoEntradaIndicePropietariosTipoIdentificacionPredio)
            _table_.get(value);
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TipoEntradaIndicePropietariosTipoIdentificacionPredio.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.supernotariado.gov.co/services/bachue/cb/indicepropietarios/consultar/v1", ">tipoEntradaIndicePropietarios>tipoIdentificacionPredio"));
    }

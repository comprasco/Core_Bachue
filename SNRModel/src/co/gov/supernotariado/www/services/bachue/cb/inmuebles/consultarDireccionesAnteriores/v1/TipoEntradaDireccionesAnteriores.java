/**
 * TipoEntradaDireccionesAnteriores.java
 *
 ...
 */
public class TipoEntradaDireccionesAnteriores implements java.io.Serializable
{
	/** Constante serialVersionUID. */
	private static final long serialVersionUID = 7707939290996212414L;

	/** Propiedad type desc. */
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
		    TipoEntradaDireccionesAnteriores.class, true
		);
	...
	private co.gov.supernotariado.www.services.bachue.cb.inmuebles.consultarDireccionesAnteriores.v1.TipoEntradaDireccionesAnterioresTipoIdentificacionPredio tipoIdentificacionPredio;

	/** Propiedad hash code calc. */
	private boolean __hashCodeCalc = false;

	/**
	 * Instancia un nuevo objeto tipo entrada direcciones anteriores.
	 */
	public TipoEntradaDireccionesAnteriores()
	{
	}
	...
	public TipoEntradaDireccionesAnteriores(
	    ...
	    co.gov.supernotariado.www.services.bachue.cb.inmuebles.consultarDireccionesAnteriores.v1.TipoEntradaDireccionesAnterioresTipoIdentificacionPredio tipoIdentificacionPredio,
	...
	/**
	 * Gets the convenio value for this TipoEntradaDireccionesAnteriores.
	 *
	...
	/**
	 * Sets the convenio value for this TipoEntradaDireccionesAnteriores.
	 *
	...
	/**
	 * Gets the tipoIdentificacionPredio value for this TipoEntradaDireccionesAnteriores.
	 *
	 * @return tipoIdentificacionPredio   * Corresponde al tipo de identificacion por el
	     *                                 cual podemos buscar un predio.
	 */
	public co.gov.supernotariado.www.services.bachue.cb.inmuebles.consultarDireccionesAnteriores.v1.TipoEntradaDireccionesAnterioresTipoIdentificacionPredio getTipoIdentificacionPredio()
	{
		return tipoIdentificacionPredio;
	}

	/**
	 * Sets the tipoIdentificacionPredio value for this TipoEntradaDireccionesAnteriores.
	 *
	...
	/**
	 * Gets the numIdentificacionPredio value for this TipoEntradaDireccionesAnteriores.
	 *
	...
	/**
	 * Sets the numIdentificacionPredio value for this TipoEntradaDireccionesAnteriores.
	 *
	...
	{
		if(!(obj instanceof TipoEntradaDireccionesAnteriores))
			return false;

		TipoEntradaDireccionesAnteriores other = (TipoEntradaDireccionesAnteriores)obj;

/**
 * TipoEntradaDatosMatriculasMatriz.java
 *
 ...
 */
public class TipoEntradaDatosMatriculasMatriz implements java.io.Serializable
{
	/** Constante serialVersionUID. */
	private static final long serialVersionUID = -4530231228681264393L;

	/** Propiedad type desc. */
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
		    TipoEntradaDatosMatriculasMatriz.class, true
		);
	...
	static
	{
		typeDesc.setXmlType(
		    new javax.xml.namespace.QName(
		        ...
		        "tipoEntradaDatosMatriculasMatriz"
		    )
		);
		...
		elemField.setXmlType(
		    new javax.xml.namespace.QName(
		        "https://www.supernotariado.gov.co/services/bachue/cb/matriculasrelacionadas/consultarMatriculasMatriz/v1",
		        ">tipoEntradaDatosMatriculasMatriz>tipoIdentificacionPredio"
		    )
		);
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
	...
	private co.gov.supernotariado.www.services.bachue.cb.matriculasrelacionadas.consultarMatriculasMatriz.v1.TipoEntradaDatosMatriculasMatrizTipoIdentificacionPredio tipoIdentificacionPredio;
	...
	/**
	 * Instancia un nuevo objeto tipo entrada datos matriculas matriz.
	 */
	public TipoEntradaDatosMatriculasMatriz()
	{
	}
	...
	public TipoEntradaDatosMatriculasMatriz(
	    ...
	    co.gov.supernotariado.www.services.bachue.cb.matriculasrelacionadas.consultarMatriculasMatriz.v1.TipoEntradaDatosMatriculasMatrizTipoIdentificacionPredio tipoIdentificacionPredio,
	...
	/**
	 * Sets the convenio value for this TipoEntradaDatosMatriculasMatriz.
	 *
	...
	/**
	 * Gets the convenio value for this TipoEntradaDatosMatriculasMatriz.
	 *
	...
	/**
	 * Sets the numIdentificacionPredio value for this TipoEntradaDatosMatriculasMatriz.
	 *
	...
	/**
	 * Gets the numIdentificacionPredio value for this TipoEntradaDatosMatriculasMatriz.
	 *
	...
	/**
	 * Sets the tipoIdentificacionPredio value for this TipoEntradaDatosMatriculasMatriz.
	 *
	...
	/**
	 * Gets the tipoIdentificacionPredio value for this TipoEntradaDatosMatriculasMatriz.
	 *
	 * @return tipoIdentificacionPredio   * Corresponde al tipo de identificacion por el
	 *                                 cual podemos buscar un predio.
	 */
	public co.gov.supernotariado.www.services.bachue.cb.matriculasrelacionadas.consultarMatriculasMatriz.v1.TipoEntradaDatosMatriculasMatrizTipoIdentificacionPredio getTipoIdentificacionPredio()
	{
	...
	{
		if(!(obj instanceof TipoEntradaDatosMatriculasMatriz))
			return false;

		TipoEntradaDatosMatriculasMatriz other = (TipoEntradaDatosMatriculasMatriz)obj;

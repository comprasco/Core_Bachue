 ...
 */
public class TipoEntradaSalvedades implements java.io.Serializable
{
	
	/** Constante serialVersionUID. */
	private static final long serialVersionUID = 627193450326295706L;

	/** Propiedad type desc. */
	// Type metadata
	private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
		    TipoEntradaSalvedades.class, true
		);
	...
	static
	{
		...
		elemField.setXmlName(
		    new javax.xml.namespace.QName(
		        "https://www.supernotariado.gov.co/services/bachue/cb/salvedades/consultarSalvedades/v1", "convenio"
		    )
		);
	...
	private co.gov.supernotariado.www.services.bachue.cb.salvedades.consultarSalvedades.v1.TipoEntradaSalvedadesTipoIdentificacionPredio tipoIdentificacionPredio;
	...
	/**
	 * Instancia un nuevo objeto tipo entrada salvedades.
	 */
	public TipoEntradaSalvedades()
	{
	}
	...
	public TipoEntradaSalvedades(
	    ...
	    co.gov.supernotariado.www.services.bachue.cb.salvedades.consultarSalvedades.v1.TipoEntradaSalvedadesTipoIdentificacionPredio tipoIdentificacionPredio,
	...
	/**
	 * Gets the convenio value for this TipoEntradaSalvedades.
	 *
	...
	/**
	 * Sets the convenio value for this TipoEntradaSalvedades.
	 *
	...
	/**
	 * Gets the tipoIdentificacionPredio value for this TipoEntradaSalvedades.
	 *
	 * @return tipoIdentificacionPredio   * Corresponde al tipo de identificacion por el
	     *                                 cual podemos buscar un predio.
	 */
	public co.gov.supernotariado.www.services.bachue.cb.salvedades.consultarSalvedades.v1.TipoEntradaSalvedadesTipoIdentificacionPredio getTipoIdentificacionPredio()
	{
		return tipoIdentificacionPredio;
	}

	/**
	 * Sets the tipoIdentificacionPredio value for this TipoEntradaSalvedades.
	 *
	...
	/**
	 * Gets the numIdentificacionPredio value for this TipoEntradaSalvedades.
	 *
	...
	/**
	 * Sets the numIdentificacionPredio value for this TipoEntradaSalvedades.
	 *
	...
	{
		if(!(obj instanceof TipoEntradaSalvedades))
			return false;

		TipoEntradaSalvedades other = (TipoEntradaSalvedades)obj;

...
public class PropietarioDTO implements java.io.Serializable
{
	...
	private static final long serialVersionUID = 2979175686605774711L;
	...
	static
	{
		...
		elemField.setXmlName(
		    new javax.xml.namespace.QName(
		        "https://www.supernotariado.gov.co/services/bachue/ee/indicepropietarios/consultar/v1", "nomPropietario"
		    )
		);
		elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
		elemField.setMinOccurs(0);
	 ...
	 * @param nomTipoDocumento correspondiente al valor de nom tipo documento
	 * @param nomPropietario correspondiente al valor de nom propietario
	 */
	public PropietarioDTO(

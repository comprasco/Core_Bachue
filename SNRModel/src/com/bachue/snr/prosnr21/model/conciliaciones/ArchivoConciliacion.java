package com.bachue.snr.prosnr21.model.conciliaciones;
 ...
 * @author Edgar Prieto
 */
public class ArchivoConciliacion extends com.bachue.snr.prosnr01.model.auditoria.Auditoria implements java.io.Serializable
{
	...
	/** Contante para identificar los archivos tipo EXB */
	public static final String TIPO_ARCHIVO_EXB = "EXB";
	...
	/** Identificación del registro detalle */
	private String is_idDetalle;
	...
	/**
	 * @param as_idDetalle Modifica el valor de la propiedad idDetalle
	 */
	public void setIdDetalle(String as_idDetalle)
	{
		is_idDetalle = as_idDetalle;
	}

	/**
	 * @return Retorna el valor de la propiedad idDetalle
	 */
	...
	/**
	 * @param as_s Modifica el valor de la propiedad ruta
	 */
	public void setRuta(String as_s)
	{
		is_ruta = as_s;
	}

	/**
	 * @return Retorna el valor de la propiedad ruta
	 */

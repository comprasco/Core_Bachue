package com.bachue.snr.prosnr16.web.listeners;
...
public class ListenerManager implements javax.servlet.ServletContextListener
{
	...
	public void contextInitialized(ServletContextEvent asce_evento)
	{
		...
		try
		{
			...
			lc_constante = new com.bachue.snr.prosnr16.web.services.delegate.ReferenceDelegate().getRemote()
					                                                                                .findConstantesById(
					    com.bachue.snr.prosnr16.common.constants.ConstanteCommon.CONFIGURACION_IDIOMA_PAIS
					);
	...
	private void initScheduler(ServletContext asc_contexto)
	{
		if(asc_contexto != null)
		{
			...
			lsnrcs_scheduler = new com.bachue.snr.prosnr16.web.Scheduler.CYNScheduler();

...
/**
 * Clase que contiene todos las propiedades y acciones de BeanDesistimiento.
 *
 * @author Julian Vaca
 */
@SessionScoped
@ManagedBean(name = "beanDesistimiento")
public class BeanDesistimiento extends BeanDigitadorMasivo implements Serializable
{
	/** Constante serialVersionUID. */
	private static final long serialVersionUID = -7003374274125137798L;
	 ...
	 */
	public String detalleDesistimiento()
	    throws B2BException
	{
		String       ls_result;
					...
					if(lbsdt_beanRecepcionDocumentos != null)
					{
						...
						if(StringUtils.isValidString(ls_idTurnoHistoria))
						{
							...
							if(lth_turnoHistoria != null)
							{
								...
								lbsdt_beanRecepcionDocumentos.setProceso(ProcesoCommon.ID_PROCESO_39);
								lbsdt_beanRecepcionDocumentos.setEtapa(EtapaCommon.ID_ETAPA_ANALISIS_DE_DESISTIMIENTO);
								lbsdt_beanRecepcionDocumentos.setRespuestaSolicitudDesistimiento(EstadoCommon.N);
								lbsdt_beanRecepcionDocumentos.cargarTextoRechazoDesistimiento();

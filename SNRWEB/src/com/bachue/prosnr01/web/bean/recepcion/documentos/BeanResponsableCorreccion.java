...
/**
 * Clase que contiene todos las propiedades y acciones de BeanResponsableCorreccion.
 *
 * @author Julian Vaca
 */
@SessionScoped
@ManagedBean(name = "beanResponsableCorreccion")
public class BeanResponsableCorreccion extends BeanCalificacion implements Serializable
{
	/** Constante serialVersionUID. */
	private static final long serialVersionUID = 6797580617097245134L;

	/** Constante CS_ID_FORM. */
	private static final String CS_ID_FORM = "fResponsableCorreccion";

	/** {@inheritdoc} */
	public void generarDatosTramiteCantidad()
	    throws B2BException
	{
		super.generarDatosTramiteCantidad(CS_ID_FORM, "" + EtapaCommon.ID_ETAPA_RESPONSABLE_CORRECCIONES, true);
	}

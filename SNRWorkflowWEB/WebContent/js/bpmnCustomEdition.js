...
function llenarInformacionEtapa(av_elementoDOM, av_etapaValida = false) {
  if (av_elementoDOM != null) {
    ...
    document.getElementById("descripcionEtapa").title = av_etapaValida ? av_elementoDOM.is_descripcion || "" :
      ...
      if (ll_dom != null) {
        ll_dom.selectValue(av_etapaValida ? av_elementoDOM.is_estado || "" : av_elementoDOM.businessObject.$attrs.estadoEtapa);
      }
    } {
      let ll_dom;
    ...
    document.getElementById("diasHabilesNormalEtapa").value = av_etapaValida ? av_elementoDOM.ibd_diasHabilesNormal || "" :
      av_elementoDOM.businessObject.$attrs.diasHabilesNormal || "";
    ...
    );
    {
      ...
      ll_dom = PF("faseEtapa");
      if (ll_dom != null) {
        ll_dom.selectValue(av_etapaValida ? av_elementoDOM.il_idFase || "" : av_elementoDOM.businessObject.$attrs.fase);
      }
    }
    {
      let ll_dom;
    ...
    setValorCheckBox(av_etapaValida ? av_elementoDOM.ib_generaQR || "" :
      av_elementoDOM.businessObject.$attrs.indGenerarQR,
      "indGenerarQREtapa"
    ); {
      let ll_dom;
...
function controlNuevoProceso(av_accionInformacion = false, av_proceso = undefined) {
  ...
  if (ll_dom != null) {
    ...
    let ll_domSub;
    ll_domSub = PF("subProcesoSOM");
    if (ll_domSub != null) {
      ll_domSub.selectValue("");
      controlNuevoSubProceso();
    }
  }
}
...
function retornarProceso(av_proceso) {
  ...
  if (av_proceso != null) {
    ...
    lv_objetoRetorno.is_recepcionDocumentos = av_proceso.recepcionDocumentosProceso || "N";
  }
...
function retornarSubProceso(av_subProceso) {
  ...
  if (av_subProceso != null) {
    ...
    lv_objetoRetorno.is_solicitudCertificado = av_subProceso.solicitudCertificadoSubproceso || "N";
    lv_objetoRetorno.is_conservacionDocumental = av_subProceso.conservacionDocumentalSubproceso || "N";
    lv_objetoRetorno.is_plantilla = av_subProceso.plantillaSubproceso || "N";
    lv_objetoRetorno.is_reciboCajaSubproceso = av_subProceso.reciboCajaSubproceso || "N";
  }
  return lv_objetoRetorno;
}
...
function limpiarCamposEtapa() {
  ...
  document.getElementById("diasHabilesNormalEtapa").value = "";
  setValorCheckBox(false, "indTopeEtapa");
  document.getElementById("faseEtapa").value = ""; {
    let ll_dom;
    ll_dom = PF("TipoRepartoSOM");
    if (ll_dom != null) {
      ll_dom.selectValue("");
  ...
  setValorCheckBox(false, "indGenerarQREtapa");
}
    ...
    if (ll_rootElements != null) {
      ...
      if (ll_attrs != null) {
        ...
        if (av_proceso != null) {
          ...
          setValorCheckBox(
            av_proceso.is_recepcionDocumentos || "N",
            "recepcionDocumentos"
          );
  ...
  if (ll_attributes != null) {
    ...
    if (ll_rootElements != null) {
      ...
      if (ll_attrs != null) {
        ...
        ll_plantilla = document.getElementById("tabProceso:plantillaSubproceso");

        if (av_subProceso != null) {
          ll_subProceso.value = av_subProceso.is_idSubproceso || "";
          ll_nombreSubProceso.value = av_subProceso.is_nombre || "";
          ll_plantilla.value = av_subProceso.is_plantilla || "";
          setValorCheckBox(
            av_subProceso.is_solicitudCertificado || "N",
            "solicitudCertificado"
          );
          setValorCheckBox(
            av_subProceso.is_reciboCajaSubproceso || "N",
            "reciboCajaSubproceso"
          );
          setValorCheckBox(
            av_subProceso.is_conservacionDocumental || "N",
...
function accionInformacionMotivoTramite() {
  ...
  document.getElementById("decisionCalificacion").value =
    lv_elementoDOM.businessObject.$attrs.decisionCalificacion || "";
...
function validarDatosEtapa() {
  ...
  lv_objetoRetorno = undefined; {
    ...
    let ll_dom;
    ll_dom = document.getElementById("diasHabilesNormalEtapa");
    if (ll_dom != null) {
      let ll_valor = ll_dom.value;
      if (isNaN(ll_valor)) {
        ll_dom.style.borderColor = "red";
        addMessage(
          "globalMsg",
          "Advertencia: ",
          "Debe ingresar una cantidad de días válida",
          "warn"
        );
        throw "La cantidad de días no es válida.";
      } else {
        ll_dom.style.borderColor = "#799DB0";
        lv_objetoRetorno.diasHabilesNormalEtapa = ll_dom.value;
      }
    }
  } {
    let ll_valor;
  ...
  {
    let ll_dom;
    ll_dom = document.getElementById("faseEtapa");
    if (ll_dom != null) {
      let ll_domSOM;
      let ll_valor;
      ll_domSOM = PF("faseEtapa");
      if (ll_domSOM != null) {
        ll_valor = ll_domSOM.getSelectedValue();
        if (!isValidString(ll_valor) || isNaN(ll_valor)) {
          ll_dom.style.borderColor = "red";
          addMessage(
            "globalMsg",
            "Advertencia: ",
            "Debe ingresar una fase válida",
            "warn"
          );
          throw "La fase de la etapa no es válida.";
        } else {
          lv_objetoRetorno.faseEtapa = ll_valor.trim();
          ll_dom.style.borderColor = "#799DB0";
        }
      }
    }
    ...
    if (ll_dom != null) {
      ...
      if (ll_domSOM != null) {
        ...
        if (!isValidString(ll_valor)) {
          ...
          lv_objetoRetorno.tipoRepartoEtapa = ll_valor.trim();
          ll_dom.style.borderColor = "#799DB0";
        }
      }
    }
  ...
  {
    let ll_valor;
    ll_valor = obtenerValorCheckBox("indGenerarQREtapa");
    if (isValidString(ll_valor)) {
      lv_objetoRetorno.indGenerarQREtapa = ll_valor;
    }
  }
  return lv_objetoRetorno;
}
...
function validarDatosMotivoTramite() {
  ...
  lv_objetoRetorno = undefined; {
    ...
    let ll_dom;
    ll_dom = document.getElementById("decisionCalificacion");
    if (ll_dom != null) {
      let ll_valor;
      ll_valor = ll_dom.value;
      lv_objetoRetorno.decisionCalificacion = ll_valor;
      ll_dom.style.borderColor = "#799DB0";
    }
  } {
    let ll_dom;
    ...
    if (ll_datosEtapa != null) {
      ...
      if (ll_businessObject != null) {
        ...
        if (ll_attrs != null) {
          ...
          ll_attrs.diasHabilesNormal = ll_datosEtapa.diasHabilesNormalEtapa;
          ll_attrs.indTope = ll_datosEtapa.indTopeEtapa;
          ll_attrs.fase = ll_datosEtapa.faseEtapa;
          ...
          ll_attrs.indGenerarQR = ll_datosEtapa.indGenerarQREtapa;
    ...
    if (ll_datosMotivo != null) {
      ...
      if (ll_businessObject != null) {
        ...
        if (ll_attrs != null) {
          ...
          ll_attrs.decisionCalificacion = ll_datosMotivo.decisionCalificacion;
        ...
        if (ll_attrs != null) {
          {
            ...
            let ll_valor;
            ll_valor = obtenerValorCheckBox("recepcionDocumentos");
            if (isValidString(ll_valor))
              ll_attrs.recepcionDocumentosProceso = ll_valor;
          }
...
function guardarCambiosSubproceso(av_attrs) {
  ...
  if (procesoValido(ll_subProceso)) {
    if (av_attrs != null) {
      ...
      {
        let ll_valor;
        ll_valor = obtenerValorCheckBox("solicitudCertificado");
        if (isValidString(ll_valor))
          av_attrs.solicitudCertificadoSubproceso = ll_valor;
      }
      {
        let ll_plantilla;
        ll_plantilla = document.getElementById("tabProceso:plantillaSubproceso")
          .value;
        if (isValidString(ll_plantilla)) {
          av_attrs.plantillaSubproceso = ll_plantilla;
        }
      }
      {
        let ll_valor;
        ll_valor = obtenerValorCheckBox("reciboCajaSubproceso");
        if (isValidString(ll_valor))
          av_attrs.reciboCajaSubproceso = ll_valor;
      }
      {
        let ll_valor;
        ll_valor = obtenerValorCheckBox("conservacionDocumental");
        if (isValidString(ll_valor))
          av_attrs.conservacionDocumentalSubproceso = ll_valor;
      }
...
function cargarInfoProceso() {
  ...
  if (ll_proceso != null) {
    document.getElementById('infoProcesos').innerHTML =
      ...
      '<b>Versión:</b> <i>' + (lvsp_subproceso != null ? lvsp_subproceso.ii_version : '1') + '</i><br/>' +
      (lab_monitoreo ? '<b>Turno:</b> <i>' + (las_turno || 'N/A') + '</i>' : '') +
      '</p>' +
      '</div>' +
      '<div class="ui-g-6 ui-md-6 ui-lg-6">' +
      '<p style="color:black">' +
      ...
      (lab_monitoreo ? '<b>NIR:</b> <i>' + (las_nir || 'N/A') + '</i>' : '') +
      '</p>' +
      '</div>' +
      '</div>';
  }
